  ...
  return (
    <div className="relative inline-flex items-center">
      <button
        ...
        className="flex items-center gap-1 text-white/40 hover:text-white/60 transition-colors group"
        style={{ fontSize: '9px' }}
      >
      ...
      {isOpen && (
        <div className="absolute bottom-full left-0 mb-1.5 w-72 max-w-[85vw] bg-black/80 backdrop-blur-xl border border-white/15 rounded-lg p-2.5 text-white/70 z-50 fade-in slide-in-from-bottom-2 shadow-xl" style={{ fontSize: '10px', lineHeight: '1.4' }}>
