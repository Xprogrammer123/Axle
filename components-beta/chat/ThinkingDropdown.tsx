  ...
  return (
    <div className="relative inline-flex items-center">
      <button
        ...
        style={{ fontSize: "9px" }}
      >
        <span className="inline-block w-1 h-1 bg-text/30 rounded-full animate-pulse" />
      ...
      {isOpen && (
        <div
          className="absolute bottom-full left-0 mb-1.5 w-72 max-w-[85vw] bg-surface/90 backdrop-blur-xl border border-border rounded-lg p-2.5 text-dark/70 z-50 fade-in slide-in-from-bottom-2 shadow-xl"
