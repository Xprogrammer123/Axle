        ...
        <div>
          ...
          {health?.summary && (
            <p className="text-white/20 text-xs mt-3">
              {health.summary.healthy} healthy • {health.summary.warnings} warnings •{" "}
              {health.summary.expired} expired
            </p>
          )}
        </div>
      </div>
            ...
            >
              <div>
                ...
                {isConnected && healthItem?.message && (
                  <p className="text-[11px] text-white/25 mt-3">{healthItem.message}</p>
                )}
              </div>
