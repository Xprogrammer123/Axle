  ...
  return (
    <div className="w-screen md:w-full h-full overflow-y-auto p-4 md:p-7 md:pt-24 pt-24">
      <div className="flex flex-col lg:flex-row gap-4 w-full">
        <div id="dashboard-agents-card" className="bg-dark/3 dark:bg-white/1.5 w-full lg:w-1/2 xl:w-[43%] overflow-hidden h-72 border-0 border-dark/3 dark:border-white/2 rounded-4xl p-3 shadow-lg shadow-dark/4 dark:shadow-black/1">
        ...
        <div className="bg-dark/3 dark:bg-white/1.5 w-full lg:w-1/2 xl:w-[57%] justify-between flex flex-col overflow-hidden h-72 border-0 border-dark/3 dark:border-white/2 rounded-4xl p-3 shadow-lg shadow-dark/4 dark:shadow-black/10">
                        ...
                        >
                          ...
                          <Button
                            ...
                            onClick={() => {
                              ...
                              // openCreateAgentModal() or router.push(...)
                            }}
      ...
      <div className="flex flex-col lg:flex-row gap-4 w-full mt-4">
        <div id="dashboard-integrations-card" className="bg-dark/3 dark:bg-white/1.5 w-full lg:w-1/2 flex flex-col overflow-hidden h-72 border-0 border-dark/3 dark:border-white/10 rounded-4xl p-3 shadow-lg shadow-dark/4 dark:shadow-black/10">
          <div className="flex w-full justify-between items-center">
        ...
        <div id="dashboard-recent-conversations" className="bg-dark/3 dark:bg-white/1.5 w-full lg:w-1/2 flex flex-col overflow-hidden h-72 border-0 border-dark/3 dark:border-white/10 rounded-4xl p-3 shadow-lg shadow-dark/4 dark:shadow-black/10">
          <div className="flex w-full justify-between items-center">
            <h2 className="text-base md:text-lg font-semibold text-dark dark:text-dark-light px-3 truncate">
