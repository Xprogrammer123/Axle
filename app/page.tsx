  ...
  return (
    <main className="overflow-x-hidden w-screen px-7 flex flex-col items-center bg-[#000B04]">
      ...
      <Image src="/logo.svg" alt="Logo" width={30} height={30} />
        ...
        <button className="py-2.5 px-7 rounded-full text-white font-semibold bg-linear-to-b from-[#36B460] hover:scale-105 transition-all duration-300 cursor-pointer to-[#049C20]">
          Get Started
        </button>
      </div>
        ...
        <div className="flex flex-col z-30 mt-36 items-center">
          ...
          <div className="flex items-center justify-center mt-8 flex-col max-w-4xl text-center gap-4">
            ...
            <div className="flex gap-3 mt-4 items-center">
              <button className="py-3.5 items-center flex gap-1.5 px-8 rounded-full text-white font-medium bg-linear-to-b from-[#36B460] hover:scale-105 transition-all duration-300 cursor-pointer to-[#049C20]">
                Check it out
